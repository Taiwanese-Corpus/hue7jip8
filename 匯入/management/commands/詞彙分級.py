...
class Command(BaseCommand):
    ...
    json網址 = 'https://xn--kbr112a4oa73rtw5adwqr1d.xn--v0qr21b.xn--kpry57d/匯出資料庫'
    ...
    def _全部資料(self):
        print(quote(self.json網址, safe=':/'))
        with urlopen(quote(self.json網址, safe=':/')) as 檔:
            return json.loads(檔.read().decode())['資料']
